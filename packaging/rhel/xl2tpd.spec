...
* Tue Sep 18 2012 Paul Wouters <pwouters@redhat.com> - 1.3.1-5
...
* Tue Jul 10 2012 Paul Wouters <pwouters@redhat.com> - 1.3.1-4
- No longer wait on the ppp package fix for pppol2tp plugin
  so the other fixes can be pushed.

* Tue Jun 12 2012 Paul Wouters <pwouters@redhat.com> - 1.3.1-3
